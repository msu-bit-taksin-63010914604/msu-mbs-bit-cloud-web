...
<p style="text-align:right;width:100%;">ยินดีต้อนรับ <strong><?php echo $_SESSION['username']; ?></strong> </p>
            <div type="button" style="text-align:right;width:100%;"> <button  class="btn btn-sm btn-outline-secondary"><a href="index.php?logout='1'" style="color: red;">ออกจากระบบ</a></button></div>
        <?php endif ?>
  ...
  <div class="album py-5 bg-light">
    <div class="container">
      ...
      <h2>product list</h2>
<p>
	<a href="basket0.php" class="btn btn-primary">shopping cart</a>
</p>
...
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
	...
	while($data= mysqli_fetch_array($rs)){
		...
		echo "<a href='basket0.php?id=$img';'<button type='submit' name='button' id='button' class='btn btn-success' role='button' >หยิบลงตะกร้า</a> <br>";
