  ...
  <header class="mb-auto">
    <div>
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link fw-bold py-1 px-0 active" aria-current="page" href="index0.php" class="btn btn-danger">กลับไปเลือกสินค้า</a>
      </nav>
    </div>
  </header>
...
?>
	<tr>
		...
		<td><a href="clear0.php?id=<?=$pid;?>" class="btn btn-danger">ลบ</a></td>
	</tr>
<?php } // end foreach ?>
	<tr>
...
<div>
<a href="record.php" class="btn btn-success btn-center">สั่งซื้อสินค้า</a></div>
</blockquote>
